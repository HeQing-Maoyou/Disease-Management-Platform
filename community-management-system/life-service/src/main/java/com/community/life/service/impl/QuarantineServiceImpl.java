...
import com.community.life.mapper.QuarantineServiceMapper;
...
public class QuarantineServiceImpl implements QuarantineService {
    ...
    public ResponseResult<?> bookService(Long userId, String serviceType, Date appointmentTime) {
        // 创建隔离服务预约记录
        com.community.common.entity.QuarantineService service = new com.community.common.entity.QuarantineService();
    ...
    public ResponseResult<?> getServices(Long userId) {
        // 查询用户的隔离服务列表
        QueryWrapper<com.community.common.entity.QuarantineService> wrapper = new QueryWrapper<>();
        wrapper.eq("user_id", userId)
               .orderByDesc("created_at");

        List<com.community.common.entity.QuarantineService> services = quarantineServiceMapper.selectList(wrapper);
    ...
    public ResponseResult<?> updateServiceStatus(Long serviceId, String status) {
        // 查询服务记录
        com.community.common.entity.QuarantineService service = quarantineServiceMapper.selectById(serviceId);
        if (service == null) {
