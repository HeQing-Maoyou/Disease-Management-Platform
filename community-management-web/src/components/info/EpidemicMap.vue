...
import { Position, Search, Location, Map, Phone, Clock, Navigation, Refresh, AlertCircle } from '@element-plus/icons-vue'
    ...
    <div class="locations-list" :loading="loading">
      ...
      >
        <div class="location-header">
          ...
          <el-tag 
            :type="location.crowdLevel === '高' ? 'danger' : location.crowdLevel === '中' ? 'warning' : 'success'"
            class="crowd-tag"
          >
